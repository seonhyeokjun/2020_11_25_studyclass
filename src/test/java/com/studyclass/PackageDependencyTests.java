...
@AnalyzeClasses(packagesOf = StudyclassApplication.class)
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("com.studyclass.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.studyclass.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.studyclass.modules.(*)..")
