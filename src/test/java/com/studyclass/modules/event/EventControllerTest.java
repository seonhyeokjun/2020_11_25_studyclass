...
import com.studyclass.modules.study.StudyFactory;
...
class EventControllerTest extends AbstractContainerBaseTest {
    ...
    void newEnrollment_to_FCFS_event_accepted() throws Exception {
        ...
        Event event = createEvent("test-event", EventType.FCFS, 2, study, hyeok);
    ...
    void accepted_account_cancelEnrollment_to_FCFS_event_not_accepted() throws Exception {
        ...
        eventService.newEnrollment(event, hyeok);

        isAccepted(may, event);
        isAccepted(seon, event);
        isNotAccepted(hyeok, event);
    ...
    void newEnrollment_to_CONFIMATIVE_event_not_accepted() throws Exception {
        Account hyeok = accountFactory.createAccount("hyeok");
        Study study = studyFactory.createStudy("test-study", hyeok);
        Event event = createEvent("test-event", EventType.CONFIRMATIVE, 2, study, hyeok);
